      ...
      <div class="main-right">
        ...
        <el-form ref="loginRef" onsubmit="return false" :model="loginForm" :rules="loginRules" class="login-form">
          <el-form-item prop="account">
            <el-input v-model="loginForm.account" type="text" size="large" autocomplete="on" :model="loginForm"
              onsubmit="return false" placeholder="账号" name="account">
              <template #prefix>
          ...
          <el-checkbox v-model="loginForm.rememberMe">记住密码
          </el-checkbox>
          <el-form-item style="width: 100%">
            <el-button :loading="loading" size="large" native-type="submit" type="primary" style="width: 100%"
          ...
          <el-form-item class="login-dev" label="dev请求路径" v-if="MODE === 'development'">
            <el-select class="select" style="width: 210px" v-model="requestPath" placeholder="请选择"
              @change="changeRequestPath">
              <el-option label="http://10.204.42.121:9090" value="http://10.204.42.121:9090"></el-option>
              <el-option label="http://10.204.42.139:9090" value="http://10.204.42.139:9090"></el-option>
              ...
              <el-option label="https://teststudy.talk915.com/" value="https://teststudy.talk915.com/leran"></el-option>
