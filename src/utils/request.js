...
function getBaseURL() {
  ...
  if (MODE === 'development') {
    ...
    // baseURL = devRequestPath ? devRequestPath : 'https://teststudy.talk915.com/learn'
    baseURL = 'https://study.talk915.com/learn'
    // baseURL = 'http://10.204.42.156:9090/learn'
    // baseURL = 'http://10.204.42.157:9090/learn'
  } else {
...
service.interceptors.response.use(
  (response) => {
    ...
    if (res.code !== 0) {
      if (res.code === 3 || res.code === 40 || res.code === 5 || res.code===7 || res.code===8 ) {
